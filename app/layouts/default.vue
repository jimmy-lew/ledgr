...
<template>
  <div class="relative min-h-screen flex flex-col bg-[oklch(96%_0_0)] dark:bg-[#070707] font-mono pt-4 gap-3">
    <div class="flex items-center justify-between w-full pt-6 px-5">
